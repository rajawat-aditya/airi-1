        ...
        <div className="
            ...
            <div className="w-full max-w-[256px] px-1 pb-0.5 pt-4 select-none">
                ...
                <div className="absolute bottom-2 w-full max-w-[256px]">
                    {/* if not signed  */}
                    {!session && (
                        <button onClick={() => window.location.href = "/auth/login"} className="group-data-[state=close]:w-9 group-data-[state=close]:h-9 flex w-full gap-2 h-10 items-center px-1.5 py-1.5 rounded-xl hover:bg-[#ffffff14] cursor-pointer transition-all duration-100 ease-in-out">
                            <span>
